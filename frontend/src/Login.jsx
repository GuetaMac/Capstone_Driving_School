...
function Login() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
    // 1. Get user info first to check role
    const preLogin = await axios.post("http://localhost:5000/check-user", {
      identifier,
    });
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8 border border-gray-100">
          ...
          <div className="mt-6 text-center">
            <p className="text-gray-600">
              ...
              <Link to="/register" className="text-red-500 hover:text-red-600 font-semibold hover:underline transition-colors">
                Register here
              </Link>
            </p>
          </div>
